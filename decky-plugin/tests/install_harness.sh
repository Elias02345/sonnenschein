...
case "$url" in
    *api.github.com*)
        printf '%s\n200' '{"assets":[{"browser_download_url":"https://example.test/Sonnenschein-Decky-Plugin-0.2.6-test.zip"},{"browser_download_url":"https://example.test/Sonnenschein_Client-0.2.6-test-x86_64.AppImage"}]}'
        ;;
...
APPIMAGE="$HOME/Applications/Sonnenschein_Client-0.2.6-test-x86_64.AppImage"
test -x "$APPIMAGE"
test -s "$APPIMAGE"
